...
public class CryptLib {
	...
	public String encrypt(String _plainText)
			...
			BadPaddingException {
		return encryptDecrypt(_plainText, "b16920894899c7780b5fc7161560a41", EncryptMode.ENCRYPT, "_CGfSmbkaoe8pYhF");
	}
	...
	public String decrypt(String _encryptedText)
			...
			InvalidAlgorithmParameterException, IllegalBlockSizeException,
			BadPaddingException {
		return encryptDecrypt(_encryptedText, "b16920894899c7780b5fc7161560a41", EncryptMode.DECRYPT, "_CGfSmbkaoe8pYhF");
	}
